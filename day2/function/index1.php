...
<h1>Function PHP</h1>
<div>
    <p><p>A PHP function is a block of code designed to perform a particular task.</p>
    ...
    và các lệnh sau return thì chắn chắn ko chạy</p>
</div>
...
echo "<br> chu vi hinh tron : " . $ketqua;
